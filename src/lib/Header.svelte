      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item header-custom-icon">
          <a class="nav-link" href="/#" id="changeThemeLight">
            <i class="icon ion-md-sunny" />
          </a>
        </li>
        <li class="nav-item header-custom-icon">
          <a class="nav-link" href="/#" id="clickFullscreen">
            <i class="icon ion-md-expand" />
          </a>
        </li>
        <li class="nav-item dropdown header-custom-icon">
          ...
          <!-- <div class="dropdown-menu">
            ...
            >
              ...
              <a href="index.html#!" class="text-muted">Clear all</a>
            </div>
            <div class="dropdown-body">
              <a href="index.html#!" class="dropdown-item">
                <div class="icon">
                  <i class="icon ion-md-lock" />
                </div>
                <div class="content">
          ...
          <div class="dropdown-menu">
            <div class="dropdown-header d-flex flex-column align-items-center">
              ...
              <div class="info text-center">
                ...
                <p class="email text-muted mb-3">support@binharvest.com</p>
              </div>
            </div>
            <div class="dropdown-body">
